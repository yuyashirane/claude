...
| 案件 | プラン | 売上 | 仕訳 | 期待月次 | 期待年次 |
|---|---|---|---|---|---|
| Bangkok Solar | 記帳代行 | 1.4億 | 不明 | 50,000 | 397,000 |
| MegaSolar | 記帳代行 | 6,000万 | 30件 | 25,000 | 245,000 |
| 企業経営サポート宮崎 | 記帳代行 | 3,500万 | 不明 | 20,000 | 205,000 |
| 日本アンプル | 記帳代行 | ほぼなし | ほぼなし | 12,000 | 175,000 |
| Back UP A1 | 記帳代行 | 2億 | 500件 | 55,000 | 292,000 |
| Back UP A2 | 記帳代行+相談 | 2億 | 500件 | 65,000 | 292,000 |
| Back UP B1 | 自計化 | 2億 | 500件 | 32,000 | 292,000 + 50,000(初年) |
| Back UP B2 | 自計化+相談 | 2億 | 500件 | 42,000 | 292,000 + 50,000(初年) |

**注**: Bangkok・Back UPは1億円超のため `manualPricing` モードで再現
