...
function toReviewRecord(item) {
  ...
  return {
    ...
    walletable_name: { value: item._freee?.walletable_type || "" },
    walletable_type: { value: item._freee?.walletable_type || "" },
    walletable_id: { value: item._freee?.walletable_id || "" },
    wallet_name: { value: item._freee?.wallet_name || "" },
