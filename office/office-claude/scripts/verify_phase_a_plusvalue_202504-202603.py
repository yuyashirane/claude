"""Phase A E2E 検証スクリプト (株式会社プラスバリュー 2025/04-2026/03)。

verify_phase8c.py を参考に、プラスバリューの会計期間全体 (2025-04-01〜2026-03-31) で
V1-3-10 checker を実行し、Phase 8-C の Excel exporter でレポートを出力する。

Usage:
    cd office/office-claude
    PYTHONIOENCODING=utf-8 py scripts/verify_phase_a_plusvalue_202504-202603.py
"""
...
BASE = Path("data/e2e/10021668/202504-202603")
COMPANY_SHORT = "plusvalue"
...
def main() -> int:
    ...
    print()
    print("=" * 64)
    print("E2E 実行（プラスバリュー 2025/04-2026/03、Phase 8-C: ctx 連携）")
    print("=" * 64)
