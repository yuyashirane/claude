...
def _make_findings() -> list[Finding]:
    ...
    return [
        ...
        f("TC-01", "TC-01-01", "🔴 High",    "direct_error",    "🔴 必須確認",
        ...
        f("TC-02", "TC-02-01", "🔴 High",    "direct_error",    "🔴 必須確認",
        ...
        f("TC-03", "TC-03-01", "🔴 High",    "direct_error",    "🔴 必須確認",
        ...
        f("TC-06", "TC-06-01", "🔴 High",    "direct_error",    "🔴 必須確認",
